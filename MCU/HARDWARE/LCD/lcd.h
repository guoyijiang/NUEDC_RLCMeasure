...
//自定义颜色
//((0x001F&RED)<<19)|((0x003F&GREEN)<<11)|((0x003F&BLUE)<<3)
//((0x001F&RED)<<11)|((0x003F&GREEN)<<5)|(0x003F&BLUE)

#define MYBLUE1 ((0x00F8&(u16)63)<<8)|((0x00FC&(u16)72)<<3)|((0x00F8&(u16)204)>>3) //大妈蓝色
#define MYBLUE2 ((0x00F8&(u16)56)<<8)|((0x00FC&(u16)85)<<3)|((0x00F8&(u16)124)>>3) //灰蓝色
#define MYRED1 ((0x00F8&(u16)119)<<8)|((0x00FC&(u16)0)<<3)|((0x00F8&(u16)18)>>3) //血红
#define MYYELLOW1 ((0x00F8&(u16)255)<<8)|((0x00FC&(u16)128)<<3)|((0x00F8&(u16)64)>>3) //橘黄色 
#define MYGRAY1 ((0x00F8&(u16)23)<<8)|((0x00FC&(u16)23)<<3)|((0x00F8&(u16)23)>>3) //灰黑色

#define MYCOLOR1 ((0x00F8&(u16)63)<<8)|((0x00FC&(u16)72)<<3)|((0x00F8&(u16)204)>>3)
