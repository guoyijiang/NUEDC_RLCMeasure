...
#set_property PACKAGE_PIN C4  [get_ports pm002];  # n
#set_property PACKAGE_PIN D4  [get_ports pm003];  # p
#set_property PACKAGE_PIN D5  [get_ports pm004];  # n
...
#PMODE3
set_property PACKAGE_PIN L14 [get_ports SCLK_AD];  # p
set_property PACKAGE_PIN M14 [get_ports MISO_AD];  # n

#set_property PACKAGE_PIN N13 [get_ports MOSI_DA];  # p
...
set_property PACKAGE_PIN P10 [get_ports CS_AD];  # p

#set_property PACKAGE_PIN P11 [get_ports SWUX];  # n
...
#set_property PACKAGE_PIN A3  [get_ports p307];  # n
#set_property PACKAGE_PIN B2  [get_ports p308];  # p
#set_property PACKAGE_PIN A2  [get_ports p309];  # n
#set_property PACKAGE_PIN B1  [get_ports p310];  # n
#set_property PACKAGE_PIN C1  [get_ports p311];  # p
#set_property PACKAGE_PIN F3  [get_ports p312];  # n
...
#set_property PACKAGE_PIN P16 [get_ports CS_AD];  # n
#set_property PACKAGE_PIN P15 [get_ports MISO_AD];  # p
#set_property PACKAGE_PIN N16 [get_ports SCLK_AD ];  # n
set_property PACKAGE_PIN M16 [get_ports SCLK_DA];  # p
set_property PACKAGE_PIN K13 [get_ports MOSI_DA];  # p
set_property PACKAGE_PIN L13 [get_ports CS_DA];  # n
