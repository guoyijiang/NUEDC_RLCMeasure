...
module Si5351_Init(
	...
	initial $readmemh("si3551_ini.dat", Si351RAMData); // Initialize the RAM
...
/***********************************************************************************************/
	reg [6:0] cnt125;
	reg en800k;                                             
	always@(posedge clk)begin								//IIC速率800K
